  ...
  public void init() throws DBException {
    synchronized (CLASS_LOCK) {
      ...
      LOGGER.log(Level.INFO, new StringBuilder()
          ...
          .append("\nSpanner built-in metrics enabled on client: ")
          .append(spanner.getOptions().isEnableBuiltInMetrics())
          .append("\nSpanner export built-in metrics to OTEL on client: ")
          .append(spanner.getOptions().isExportBuiltInMetricsToOpenTelemetry())
          .append("\nTracing enabled: ")
